    ...
    <header style={{
      ...
      <div style={{
        ...
        <nav className="nav-links">
          ...
          <a href="https://yourwebsite.com/?yetti-rental=true&location=631aa7fb-90ae-4a7a-acce-d2d38f516b83" target="_blank" rel="noopener" style={{
      ...
      <div className={`mobile-menu${menuOpen ? ' open' : ''}`}>
        ...
        <a href="https://yourwebsite.com/?yetti-rental=true&location=631aa7fb-90ae-4a7a-acce-d2d38f516b83"
